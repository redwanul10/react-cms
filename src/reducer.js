  ...
  switch (action.type) {
    ...
    case "ADD_FIELD":
      ...
      if (state.groupFieldId) {
        ...
        addfieldNested(contentTypes[state.activeIndex].fields);
      } else {
        contentTypes[state.activeIndex].fields.push(field);
      }
    ...
    case "DELETE_FIELD":
      if (action.payload.groupFieldId) {
        ...
        deletefieldNested(newState.contentTypes[state.activeIndex].fields);
      ...
      state.contentTypes[state.activeIndex].fields = state.contentTypes[
        state.activeIndex
      ].fields.filter((field) => {
        return field.fieldId !== action.payload.fieldId;
      });
    ...
    case "UPDATE_FIELD":
      ...
      updatefieldNested(newState.contentTypes[state.activeIndex].fields);
    ...
    case "Field_Sorted":
      ...
      if (parentFieldId) {
        ...
        sortNestedField(newstate.contentTypes[state.activeIndex].fields);
      ...
      state.contentTypes[state.activeIndex].fields = action.payload.fields;
